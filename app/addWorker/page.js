    ...
    try {
      ...
      if (profilePicture) {
        const profilePictureRef = ref(
          storage,
          `managers/${user.uid}/profilePictures/${profilePicture.name}`
        );
      ...
      await setDoc(
        doc(db, "managers", user.uid, "workers", `${firstName}_${lastName}`),
        workerData
      );
    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-300 via-blue-600 to-blue-800 flex flex-col justify-center items-center text-white">
      <div className="bg-black opacity-85 p-10 rounded-lg shadow-lg w-full max-w-4xl">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-4xl font-comfortaa font-bold text-white">Add Worker</h1>
          <Link
            href="/workers"
        ...
        <form onSubmit={handleAddWorker} className="space-y-6">
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full md:w-1/2 px-4 mb-6">
              <label className="block text-white font-comfortaa font-semibold">First Name</label>
              <input
                type="text"
                value={firstName}
            ...
            <div className="w-full md:w-1/2 px-4 mb-6">
              <label className="block text-white font-comfortaa font-semibold">Last Name</label>
              <input
                type="text"
                value={lastName}
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full md:w-1/2 px-4 mb-6">
              <label className="block text-white font-comfortaa font-semibold">Phone Number</label>
              <input
                type="tel"
                value={phoneNumber}
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full md:w-1/2 px-4 mb-6">
              <label className="block text-white font-comfortaa font-semibold">Start Date</label>
              <input
                type="date"
                value={startDate}
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full md:w-1/3 px-4 mb-6">
              <label className="block text-white font-comfortaa font-semibold">Postal Code</label>
              <input
                type="text"
                value={zipCode}
